...
@section('content_bo')
    <div class="container bg-light">
        <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">Modification d'équipes</h2>
            <form action='/dashboard/readEquipes/{{$edit->id}}' method="post">
                @csrf
                @method('put')
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="nom">Nom de l'équipe</label>
                        <input id="nom" name='nom' value='{{ $edit->nom }}' type="text"
                    ...
                    <div>
                        ...
                        <input id="ville" name='ville' value='{{$edit->ville }}' type="text"
                    ...
                    <div>
                        ...
                        <input id="pays" name='pays' value='{{ $edit->pays}}' type="text"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select
                                ...
                                <option
                                    class="block px-4 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-blue-500 hover:text-white dark:hover:text-white" value="{{$continent->id}}" {{$edit->continents->id == $continent->id? 'selected': null}}>{{$continent->name}}
