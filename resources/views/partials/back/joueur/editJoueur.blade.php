...
@section('content_bo')
    <div class="container bg-light">
        <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">Modification de Joueurs</h2>
            <form action='/dashboard/readJoueurs/{{$edit->id}}' method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input id="prenom" name='prenom' value='{{$edit->prenom}}' type="text"
                    ...
                    <div>
                        ...
                        <input id="age" name='age' value='{{$edit->age}}' type="number"
                    ...
                    <div>
                        ...
                        <input id="phone" name='phone' value='{{$edit->phone}}' type="text"
                        ...
                        <div class="relative">
                            ...
                            <select class="absolute z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl dark:bg-gray-800"
                                ...
                                @foreach ($roles as $role)
                                    <option
                                        class="block px-4 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-blue-500 hover:text-white dark:hover:text-white"
                                        value="{{ $role->id }}" {{$edit->roles->id == $role->id? 'selected': null}}>{{ $role->role }}
                        ...
                        <div class="relative">
                            ...
                            <select class="absolute z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl dark:bg-gray-800"
                                ...
                                @foreach ($equipes as $equipe)
                                    <option
                                        class="block px-4 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-blue-500 hover:text-white dark:hover:text-white"
                                        value="{{ $equipe->id }}" {{$edit->equipes->id == $equipe->id? 'selected': null}}>{{ $equipe->nom }}
                    ...
                    <div>
                        ...
                        {{-- @foreach ($photos as $photo) --}}
                            ...
                            <input id="photo" name='src'  type="file"
